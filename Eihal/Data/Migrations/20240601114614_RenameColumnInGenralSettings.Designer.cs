...
namespace Eihal.Data.Migrations
{
    ...
    [Migration("20240601114614_RenameColumnInGenralSettings")]
    partial class RenameColumnInGenralSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eihal.Data.Entites.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.GeneralSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsProfessionalCategoryRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSignedContractRequired")
                        .HasColumnType("bit");

                    b.Property<string>("SitePercentage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.OrderServiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.ReferralRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.TimeClinicLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderDetailServices", b =>
                {
                    ...
                    b.HasKey("OrderDetailsId", "ServicesId");
            ...
            modelBuilder.Entity("Eihal.Data.Entites.OrderServiceDetail", b =>
                {
                    b.HasOne("Eihal.Data.Entites.OrderDetail", null)
                        .WithMany("OrderServicesDetails")
            ...
            modelBuilder.Entity("Eihal.Data.Entites.ReferralRequest", b =>
                {
                    ...
                    b.HasOne("Eihal.Data.Entites.OrderDetail", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Eihal.Data.Entites.TimeClinicLocation", b =>
                {
                    ...
                    b.HasOne("Eihal.Data.Entites.District", "Districts")
                        .WithMany()
                    ...
                    b.HasOne("Eihal.Data.Entites.UserProfile", "UserProfile")
                        .WithOne("TimeClinicLocation")
                        .HasForeignKey("Eihal.Data.Entites.TimeClinicLocation", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Eihal.Data.Entites.UserCompany", b =>
                {
                    b.HasOne("Eihal.Data.Entites.InsuranceCompany", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("OrderDetailServices", b =>
                {
                    ...
                    b.HasOne("Eihal.Data.Entites.Services", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Eihal.Data.Entites.OrderDetail", b =>
                {
                    b.Navigation("OrderServicesDetails");
                });
            ...
            modelBuilder.Entity("Eihal.Data.Entites.UserProfile", b =>
                {
                    ...
                    b.Navigation("TimeClinicLocation")
                        .IsRequired();
                });
